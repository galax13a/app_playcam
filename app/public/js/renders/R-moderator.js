...
function GetButtonsEvents() {
    ...
    *//*
    ...
    document.getElementById('btn-moderator-Entranimiento').addEventListener('click', function () {
        console.log('Click en Entranimiento Modertor');
    });

    document.getElementById('btn-moderator-see-models').addEventListener('click', function () {
